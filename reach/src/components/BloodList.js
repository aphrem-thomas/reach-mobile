...
class BloodList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={{ fontSize: 20 }}>Blood Details</Text>
                    <View style={{ flex: 1}} >
...
export default connect(mapStateToProps)(BloodList);